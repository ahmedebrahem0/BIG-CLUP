...
import { clubSchema, type ClubSchemaValues } from "../schema/club.schema";
...
type ClubFormProps = {
  ...
  onSubmit: (values: ClubSchemaValues) => Promise<void>;
};
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogHeader className="px-6 pt-6">
            <DialogTitle className="text-xl font-semibold text-foreground">
              {mode === "create" ? "إضافة نادي جديد" : "تعديل بيانات النادي"}
            </DialogTitle>
            <DialogDescription className="leading-7">
              {mode === "create"
                ? "أضف اسم النادي ليظهر مباشرة ضمن قاعدة الأندية الرئيسية."
                : "حدّث اسم النادي مع الحفاظ على نفس المعرف في النظام."}
            </DialogDescription>
          </DialogHeader>
